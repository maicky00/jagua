 ...
 * @author Marco
 */
public class FrmListaUsuarioSinAguasobrante extends javax.swing.JFrame {

    classusuario us = new classusuario();
    classAguasobrante cas= new classAguasobrante();

    /**
     * Creates new form FrmBusqueda2
     */
    public FrmListaUsuarioSinAguasobrante() {
        initComponents();
...
//       
        cas.cargarTablaUsuarioSinAguasobrante(jTable1);
    ...
    private void initComponents() {
        ...
        txtbuscar.setBorder(javax.swing.BorderFactory.createTitledBorder("Buscar: (Solo Digitar) Primero (Apellidos) Seguido(Nombres) "));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icon16x16/application_view_detail.png"))); // NOI18N
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            int n = jTable1.getSelectedRow();
            FrmAguasobrante.txtCodigoaguasobrante.setText(jTable1.getValueAt(n, 0).toString());
            FrmAguasobrante.txtUsuarioCed.setText(jTable1.getValueAt(n, 1).toString());
            FrmAguasobrante.txtNombre.setText(jTable1.getValueAt(n, 2).toString());
            FrmAguasobrante.txtUsuarioCed.setEnabled(false);
            FrmAguasobrante.lblIdUsuario.setText(jTable1.getValueAt(n, 0).toString());
            FrmAguasobrante.txtvalorConexion.setText("0");
...
//            txtObservacion.setText(jTable1.getValueAt(n, 9).toString());
    ...
    private void txtbuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarKeyReleased
        ...
        try {
            ...
            us.cargarTablaUsuarioBuscar(jTable1, txtbuscar.getText());
        } catch (Exception e) {
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmListaUsuarioSinAguasobrante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListaUsuarioSinAguasobrante().setVisible(true);
            }
        });
    }
