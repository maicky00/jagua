 ...
 * @author Marco
 */
public class FrmListaUsuarioSinMedidor extends javax.swing.JFrame {
     ...
     */
    public FrmListaUsuarioSinMedidor() {
        initComponents();
...
//       
        us.cargarTablaUsuarioSinMedidor(jTable1);
...
//            txtObservacion.setText(jTable1.getValueAt(n, 9).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmListaUsuarioSinMedidor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListaUsuarioSinMedidor().setVisible(true);
            }
        });
    }
